...
// The compiler excludes registry entries that are not yet fully verified/enabled.
...
console.log(JSON.stringify({ intent, strategy, policy, multiplierRoundTrip:true, byokRoundTrip:true }, null, 2));
